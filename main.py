...
# Main Frame Assets
createNoteBtnImg = PhotoImage(
    file="Assets/createANoteButton.png"
)  # Lighter shade variant of Create Note Button
createNoteBtnImg2 = PhotoImage(
    file="Assets/createANoteButton2.png"
)  # Darker shade variant of Create Note Button
pinBtnImage = PhotoImage(
    file="Assets/pinButton.png"
)  # Lighter shade variant of the Pin Button
pinBtnImage2 = PhotoImage(
    file="Assets/pinButton2.png"
)  # Darker shade variant of the Pin Button
...
saveBtnImg = PhotoImage(
    file="Assets/saveButton.png"
)  # Lighter shade variant of Save Buton
saveBtnImg2 = PhotoImage(
    file="Assets/saveButton2.png"
)  # Darker shade variant of Save Button
entryBoxImg = PhotoImage(file="Assets/entryBox.png")  # Rounded box for entry box
entryBoxRedImg = PhotoImage(
    file="Assets/entryBoxRed.png"
)  # Red color variant of the rounded entry box for UI
entryBoxOrangeImg = PhotoImage(
    file="Assets/entryBoxOrange.png"
)  # Orange color variant of the rounded entry box for UI
entryBoxYellowImg = PhotoImage(
    file="Assets/entryBoxYellow.png"
)  # Yellow color variant of the roundedentry box for UI
entryBoxGreenImg = PhotoImage(
    file="Assets/entryBoxGreen.png"
)  # Green color variant of the rounded entry box for UI
entryBoxBlueImg = PhotoImage(
    file="Assets/entryBoxBlue.png"
)  # Blue color variant of the rounded entry box for UI
entryBoxPurpleImg = PhotoImage(
    file="Assets/entryBoxPurple.png"
)  # Purple color variant of the rounded entry box for UI
entryBoxBlackImg = PhotoImage(
    file="Assets/entryBoxBlack.png"
)  # Black color variant of the rounded entry box for UI
confirmationBtnImg = PhotoImage(
    file="Assets/confirmationButton.png"
)  # Lighter shade variant of the 1st confirmation button
confirmationBtnImg2 = PhotoImage(
    file="Assets/confirmationButton2.png"
)  # Darker shade variant of the 1st confirmation button
confirmationBtnImg3 = PhotoImage(
    file="Assets/confirmationButton3.png"
)  # Lighter shade variant of the 2nd confirmation button
confirmationBtnImg4 = PhotoImage(
    file="Assets/confirmationButton4.png"
)  # Darker shade variant of the 2nd confirmation button
confirmationBtnImg5 = PhotoImage(
    file="Assets/confirmationButton5.png"
)  # Lighter shade variant of the 3rd confirmation button
confirmationBtnImg6 = PhotoImage(
    file="Assets/confirmationButton6.png"
)  # Darker shade variant of the 3rd confirmation button
# Functions ----------------------------------------------------------------------------------
"""
...
def onCreateNoteBtnEnter(
    event,
):  # When the mouse cursor hovers over the button, make it a darker shade
    createNoteBtn.config(image=createNoteBtnImg2)


def onCreateNoteBtnLeave(
    event,
):  # When the mouse cursor stops hovering over the button, make it a lighter shade
...
def saveToOne():  # Overwrites the  first note in the main frame to the note from the customization frame
    ...
    savedNote1ContentText.config(
        bg=modifiedColor, state="normal"
    )  # Enables the "normal" state of the text widget in order to insert text
    savedNote1ContentText.insert(INSERT, contentText.get("1.0", "end-1c"))
    savedNote1ContentText.config(
        font=(currentFont, 10), state="disabled"
    )  # Makes the text widget not editable anymore
...
def setNoteColor(
    selectedColor,
):  # Change the note color according to the selected color
...
# Pin Button
pinned = False
pinButton = Button(mainFrame, bg="White", bd=0, command=pinWindow)
pinButton.place(x=13, y=8)
updatePin()

# Note Count Label
noteCountLabel = Label(
    mainFrame,
    bg="White",
    fg="Black",
    text="Note-Taker",
...
savedNote1TitleLabel = Label(
    savedNote1Frame, bg="White", text="Title", fg="Black", font=("Arial Unicode MS", 10)
)
savedNote1TitleLabel.place(x=10, y=3)
savedNote1SeparationLabel = Label(
    savedNote1Frame, bg="White", text="----------", fg="Black"
)
...
savedNote1ContentText = Text(
    savedNote1ContentFrame,
    bg="White",
    fg="Black",
    font=("Arial Unicode MS", 10),
    state="disabled",
...
editButton = Button(
    savedNote1Frame, bg="White", image=editBtnImage, bd=0, command=editContent
)
...
savedNote2TitleLabel = Label(
    savedNote2Frame, bg="White", text="Title", fg="Black", font=("Arial Unicode MS", 10)
)
savedNote2TitleLabel.place(x=10, y=3)
savedNote2SeparationLabel = Label(
    savedNote2Frame, bg="White", text="----------", fg="Black"
)
...
savedNote2ContentText = Text(
    savedNote2ContentFrame,
    bg="White",
    fg="Black",
    font=("Arial Unicode MS", 10),
    state="disabled",
...
editButton2 = Button(
    savedNote2Frame, bg="White", image=editBtnImage, bd=0, command=editContent2
)
...
savedNote3TitleLabel = Label(
    savedNote3Frame, bg="White", text="Title", fg="Black", font=("Arial Unicode MS", 10)
)
savedNote3TitleLabel.place(x=10, y=3)
savedNote3SeparationLabel = Label(
    savedNote3Frame, bg="White", text="----------", fg="Black"
)
...
savedNote3ContentText = Text(
    savedNote3ContentFrame,
    bg="White",
    fg="Black",
    font=("Arial Unicode MS", 10),
    state="disabled",
...
editButton3 = Button(
    savedNote3Frame, bg="White", image=editBtnImage, bd=0, command=editContent3
)
...
# Pin Button
pinButton2 = Button(creationFrame, bg="White", bd=0, command=pinWindow2)

pinButton2.place(x=13, y=8)

# Note Frame
noteFrame = Frame(
    creationFrame, bg="White", highlightbackground="#658dff", highlightthickness=1
)
noteFrame.place(x=25, y=60, width=250, height=300)

# Note Title Entry Box
noteTitleLabel = Label(
    creationFrame,
    bg="White",
    fg="Black",
    text="Note Creation",
...
entryBoxLabel = Label(noteFrame, bg="White", image=entryBoxImg)
entryBoxLabel.place(x=5, y=7)

titleEntryBox = Entry(
    noteFrame, bg="White", fg="Black", bd=0, font=("Arial Unicode MS", 10), width=24
)
titleEntryBox.place(x=10, y=20)

separationLabel = Label(
    noteFrame,
    bg="White",
    fg="Black",
    bd=0,
...
color.set("White")
colorOptionMenu = OptionMenu(
    customizationFrame, color, *colorOptionList, command=findNoteColor
)
colorOptionMenu.place(x=0, y=25)
instructionLabel4 = Label(
    customizationFrame,
    bg="White",
    fg="Black",
    text="Pick a Font",
...
fontOptionMenu = OptionMenu(
    customizationFrame, fontChosen, *fontOptionsList, command=setFont
)
...
confirmationFrame = Frame(
    customizationFrame, bg="White", highlightbackground="#658dff", highlightthickness=1
)
confirmationFrameLabel = Label(
    confirmationFrame,
    bg="White",
...
confirmationBtn = Button(
    confirmationFrame, bg="White", image=confirmationBtnImg, bd=0, command=saveToOne
)
...
confirmationBtn2 = Button(
    confirmationFrame, bg="White", image=confirmationBtnImg3, bd=0, command=saveToTwo
)
...
confirmationBtn3 = Button(
    confirmationFrame, bg="White", image=confirmationBtnImg5, bd=0, command=saveToThree
)
